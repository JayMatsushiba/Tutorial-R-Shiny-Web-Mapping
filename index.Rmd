...
Let's create a new file called `R/app.R`. This single file will contain all of the code we need for our Shiny app for now. The code below has the basic structure of a Shiny App, and is pretty much the simplest Shiny App that you can create. 
```{r, eval=FALSE}
