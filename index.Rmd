...
Since we only need to load in our data once when the application launches, we can put the line of code at the top level: 
```{r, eval=FALSE}
library(shiny)
...
Believe it or not, we already have the foundations necessary to create a simple web map with Shiny! 
